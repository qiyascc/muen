...
class TrendyolProductManager:
    ...
    def create_product(self, product_data):
        ...
        try:
            ...
            attributes = self._get_category_attributes(category_id)
    ...
    def _build_product_payload(self, product, category_id, brand_id, attributes):
        ...
        # Normalize title and limit to 100 characters
        ...
        return {
            "items": [{
                ...
                "vatRate": 10,  # Fixed VAT rate as requested
    ...
    def _get_category_attributes(self, category_id):
        """Get required attributes for a category directly from the API"""
        attributes = []
