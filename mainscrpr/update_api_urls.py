...
# Define correct URL
CORRECT_URL = "https://apigw.trendyol.com"
...
def main():
  ...
  for config in configs:
    ...
    if old_url != CORRECT_URL:
      print(
          f"Updating config '{config.name}' URL from '{old_url}' to '{CORRECT_URL}'"
      )
      ...
      print(
          f"Config '{config.name}' already has the correct URL: '{config.base_url}'"
      )
