...
from trendyol import trendyol_api_working as trendyol_api_new
...
class ProductAdmin(ModelAdmin):
  ...
  def send_to_trendyol(self, request, queryset):
    ...
    def process_product(product):
      try:
        import trendyol.trendyol_api_working as trendyol_for_lc_to_trendyol
        # Convert to Trendyol product
        trendyol_product = trendyol_for_lc_to_trendyol.create_trendyol_product(
            product)
